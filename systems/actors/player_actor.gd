...
func load_from_gm() -> void:
	...
	divine_sense = GameManager.divine_sense
	speed = GameManager.speed
	active_techniques = GameManager.active_techniques.duplicate()
	active_buffs = GameManager.active_buffs.duplicate()
	base_meridian = GameManager.base_meridian.duplicate(true) if GameManager.base_meridian else null
	...
	card_instance_registry = GameManager.card_instance_registry.duplicate()
...
func save_to_gm() -> void:
	...
	GameManager.luck = luck
	GameManager.divine_sense = divine_sense
	...
	GameManager.base_meridian = base_meridian.duplicate(true) if base_meridian else null
	...
	GameManager.card_instance_registry = card_instance_registry.duplicate()
